...
- Name: swipe-flow.spec.ts >> Authentication >> shows OTP input after phone submission
- Location: tests\e2e\swipe-flow.spec.ts:52:7
...
Locator: locator('input[placeholder="••••••"]')
Expected: visible
Timeout: 5000ms
